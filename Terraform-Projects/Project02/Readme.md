...
The goal of this project is to build a foundational **Azure Landing Zone (Enterprise-Scale)** framework. This architecture establishes a secure, prebuilt, multi-subscription environment prepared for enterprise workloads to be deployed smoothly and at scale.
...
#### 4. `Project02.tf` / `main.tf` (The Builder)
